...
@Component({
  selector: "app-uni-design-system",
  standalone: true,
  imports: [ButtonModule, DialogModule, InputOtpModule, FormsModule],
  templateUrl: "./uni-design-system.component.html",
  styleUrl: "./uni-design-system.component.scss",
})
export class UniDesignSystemComponent implements AfterViewInit {
